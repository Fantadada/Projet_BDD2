-- ============================================================
-- 1. INSERTION DES TABLES "PARENTS" (Référentiels)
-- ============================================================
...
-- Personnel (IDs modifiés en VARCHAR pour correspondre au schéma)
...
-- ============================================================
-- 2. INSERTION DES TABLES "FILLES" (Héritage & Dépendances)
-- ============================================================

-- Scientifiques
INSERT INTO SCIENTIFIQUE (id_Personnel_fk, grade) VALUES 
('s01', 'cr1'),           -- Marie Dupont
('s02', 'mcf hors classe'), -- Pierre Martin
('s03', 'cr1'), --Azi Jean
('s04', 'dr1'), --Tesla Nikola
('s05', 'dr2');
-- Doctorants
...
-- ============================================================
-- 3. INSERTION DES ROLES SPECIFIQUES (Sous-types Scientifiques)
-- ============================================================
...
-- Le porteur est maintenant un ID VARCHAR ('s01', 's02')
...
-- ICI : On s'assure que d001 a des encadrants pour votre requête
